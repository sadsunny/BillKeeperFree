...
public class RecurringEventById {
	...
	public static List<Map<String, Object>> recurringData(Context context,int account_id) { //�ظ��¼���ģ�崦�?��������¼�(������ڶ�)
		...
		for ( Map<String, Object> iMap : tDataList) {
	        ...
	        * ��ʼ�����ظ������¼������¼���������ʱ�ϲ�
	        */
	       getObjectDate(context, account_id);
...
//	       Log.v("mtest", "finalDataList�Ĵ�С"+finalDataList.size());
	...
	public static List<Map<String, Object>> getTemplateDate(Context context,int account_id){ //��ȡ�ظ��¼���ģ��Bill����
	    ...
	    bksql = new BillKeeperSql(context); 
	  	...
	  	String  sql = " select BK_Bill.* ,BK_Account.bk_accountName ,BK_Account.accounthasCategory,BK_Category.bk_categoryIconName ,BK_Category.bk_categoryName from BK_Bill,BK_Account,BK_Category where BK_Bill.bk_billisRepeat = 1 and BK_Category._id =BK_Account.accounthasCategory and BK_Bill.billhasAccount = BK_Account._id and BK_Bill.billhasAccount = "+account_id;
...
public static List<Map<String, Object>> getObjectDate(Context context ,int account_id){ //��ȡ�ظ��¼�������BillObject����
		
	    oDataList.clear();
	    Map<String, Object> bMap;
	    bksql = new BillKeeperSql(context); 
	  	SQLiteDatabase db = bksql.getReadableDatabase();
	  	String  sql = "select BK_BillObject.* ,BK_Account.bk_accountName ,BK_Account.accounthasCategory ,BK_Category.bk_categoryIconName ,BK_Category.bk_categoryName from BK_BillObject ,BK_Account,BK_Category where BK_BillObject.billObjecthasAccount = "+account_id+" and BK_BillObject.billObjecthasAccount = BK_Account._id and BK_Category._id =BK_Account.accounthasCategory ";
