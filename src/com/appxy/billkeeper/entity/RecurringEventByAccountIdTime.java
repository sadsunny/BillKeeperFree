...
public class RecurringEventByAccountIdTime {
	...
	public static List<Map<String, Object>> recurringData(Context context,int account_id,long start,long end) { //�ظ��¼���ģ�崦�?��������¼�(������ڶ�)
		
		getTemplateDate(context,account_id);
		finalDataList.clear();
		for ( Map<String, Object> iMap : tDataList) {
	         ...
	         Calendar calendar = Calendar.getInstance();
 	         ...
 	         if (virtualLong == startDate) {     //��Ҫ���ʱ��,С�ڵ��ڸ���ʱ�䣬˵������Ǹ��¼���ݣ�����һ���������
	            ...
	            bMap.put("bk_categoryName", bk_categoryName);
 	            ...
 	            bMap.put("bk_accountNo", bk_accountNo);
	        ...
	        * ��ʼ�����ظ������¼������¼���������ʱ�ϲ�
	        */
	       getObjectDate(context,account_id ,start,end);
...
//	       Log.v("mtest", "finalDataList�Ĵ�С"+finalDataList.size());
	...
	public static List<Map<String, Object>> getTemplateDate(Context context,int account_id){ //��ȡ�ظ��¼���ģ��Bill����
		
	    tDataList.clear();
	    Map<String, Object> bMap;
	    bksql = new BillKeeperSql(context); 
	  	SQLiteDatabase db = bksql.getReadableDatabase();
	  	String  sql = " select BK_Bill.* ,BK_Account.bk_accountName ,BK_Account.accounthasCategory,BK_Category.bk_categoryIconName ,BK_Category.bk_categoryName,BK_Category._id, BK_Account.bk_accountNo from BK_Bill,BK_Account,BK_Category where BK_Bill.bk_billisRepeat = 1 and "+account_id+" = BK_Account._id and BK_Bill.billhasAccount = BK_Account._id and BK_Category._id = BK_Account.accounthasCategory ";
	    ...
	    while (cursorEA.moveToNext()) {
         ...
         String bk_accountNo = cursorEA.getString(30);
...
public static List<Map<String, Object>> getObjectDate(Context context ,int account_id,long start ,long end){ //��ȡ�ظ��¼�������BillObject����
		
	    oDataList.clear();
	    Map<String, Object> bMap;
	    bksql = new BillKeeperSql(context); 
	  	SQLiteDatabase db = bksql.getReadableDatabase();
	  	String  sql = "select BK_BillObject.* ,BK_Account.bk_accountName ,BK_Account.accounthasCategory ,BK_Category.bk_categoryIconName ,BK_Category.bk_categoryName,BK_Category._id,BK_Account.bk_accountNo from BK_BillObject ,BK_Account,BK_Category where BK_BillObject.billObjecthasAccount = BK_Account._id and "+account_id+" = BK_Account._id and BK_Category._id = BK_Account.accounthasCategory and BK_BillObject.bk_billODueDate >="+start+" and BK_BillObject.bk_billODueDate <= "+end;
