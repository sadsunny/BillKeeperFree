...
public class RecurringEventService {
	...
	public static List<Map<String, Object>> recurringData(Context context,long start,long end) { //�ظ��¼���ģ�崦�?��������¼�(������ڶ�)
		...
		getTemplateDate(context,start,end);
		finalDataList.clear();
...
//	       Log.v("mtest", "finalDataList�Ĵ�С"+finalDataList.size());
	...
	public static List<Map<String, Object>> getTemplateDate(Context context ,long start,long end){ //��ȡ�ظ��¼���ģ��Bill����
		
	    tDataList.clear();
	    Map<String, Object> bMap;
	    bksql = new BillKeeperSql(context); 
	  	SQLiteDatabase db = bksql.getReadableDatabase();
	  	String  sql = " select BK_Bill.* ,BK_Account.bk_accountName ,BK_Account.accounthasCategory,BK_Category.bk_categoryIconName ,BK_Category.bk_categoryName,BK_Category._id from BK_Bill,BK_Account,BK_Category where BK_Bill.bk_billisReminder = 1 and BK_Bill.bk_billisRepeat = 1 and BK_Category._id =BK_Account.accounthasCategory and BK_Bill.billhasAccount = BK_Account._id and (BK_Bill.bk_billEndDate >"+ start +" or BK_Bill.bk_billEndDate = -1) and BK_Bill.bk_billDuedate <= "+end;
...
public static List<Map<String, Object>> getObjectDate(Context context , long start ,long end){ //��ȡ�ظ��¼�������BillObject����
	    ...
	    bksql = new BillKeeperSql(context); 
	  	SQLiteDatabase db = bksql.getReadableDatabase();
	  	String  sql = "select BK_BillObject.* ,BK_Account.bk_accountName ,BK_Account.accounthasCategory ,BK_Category.bk_categoryIconName ,BK_Category.bk_categoryName,BK_Category._id from BK_BillObject ,BK_Account,BK_Category where  BK_BillObject.bk_billOisReminder = 1 and BK_BillObject.billObjecthasAccount = BK_Account._id and BK_Category._id =BK_Account.accounthasCategory and BK_BillObject.bk_billODueDate >="+start+" and BK_BillObject.bk_billODueDate <= "+end;
