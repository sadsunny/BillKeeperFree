...
import android.widget.TextView;
	...
	public class DialogAccountItemAdapter extends BaseAdapter{
		
		private String[] data = {"Edit","Export","Delete","Edit Account List"};
		private LayoutInflater mInflater;
		private Context context;
		    
	    public  DialogAccountItemAdapter(Context context) {
