...
public class CategoryFragmentExpandableListviewAdapter extends BaseExpandableListAdapter{
	
	private LayoutInflater inflater;
    private List<Map<String, Object>> groupList;
	private List<List<Map<String, Object>>> childList;
 
    public CategoryFragmentExpandableListviewAdapter(Context context, List<Map<String, Object>> groupList, List<List<Map<String, Object>>> childList) {
