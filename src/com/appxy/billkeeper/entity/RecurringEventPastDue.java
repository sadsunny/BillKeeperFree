...
public class RecurringEventPastDue {
	public   List<Map<String, Object>> pfinalDataList = new ArrayList<Map<String, Object>>(); ; //���յ����list
	public   List<Map<String, Object>> ptDataList = new ArrayList<Map<String, Object>>();//�ظ��¼���ģ�����
	public   List<Map<String, Object>> poDataList = new ArrayList<Map<String, Object>>();
	public   List<Map<String, Object>> pvirtualDataList; //���ÿһ����ģ����ɵĵ�����datalist
	public   BillKeeperSql bksql;
	public final long DAYMILLIS = 86400000L;
	
	public  List<Map<String, Object>> recurringData(Context context,long start,long end) { //�ظ��¼���ģ�崦�?��������¼�(������ڶ�)
		
		pgetTemplateDate(context);
		pfinalDataList.clear();
		for ( Map<String, Object> iMap : ptDataList) {
	         ...
	         Calendar calendar = Calendar.getInstance();
 	         ...
 	         pvirtualDataList = new ArrayList<Map<String, Object>>();
 	      ...
 	      if (bk_billRepeatType == 1 ) { //�����������¼����������һ�γ�����ʱ��ε��¼�ʱ��
	         ...
	         pfinalDataList.addAll(pvirtualDataList);
	        ...
	        * ��ʼ�����ظ������¼������¼���������ʱ�ϲ�
	        */
	       pgetObjectDate(context,start,end);
	       ...
	       for(Map<String, Object> fMap:pfinalDataList){ //���������¼�
...
//	    	   if (pflag == 2) { //ֻ����flagΪ2�������¼�
	    		   ...
	    		   for (Map<String, Object> oMap:poDataList) {
...
//	       Log.v("mtest", "delectDataListO�Ĵ�С"+delectDataListO.size());
	       pfinalDataList.removeAll(delectDataListf);
	       poDataList.removeAll(delectDataListO);
	       pfinalDataList.addAll(poDataList);
//	       Log.v("mtest", "finalDataList�Ĵ�С"+finalDataList.size());
	       
		return pfinalDataList;
	}
	
	public  List<Map<String, Object>> pgetTemplateDate(Context context){ //��ȡ�ظ��¼���ģ��Bill����
	    ...
	    Log.v("mtest", "ģ���С��"+ptDataList.size());
	    cursorEA.close();  
	    db.close();
...
public  List<Map<String, Object>> pgetObjectDate(Context context , long start ,long end){ //��ȡ�ظ��¼�������BillObject����
